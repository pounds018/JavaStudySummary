package cn.pounds.grpc.examples.routeguide;
...
public class RouteGuideClient {
	...
	public void getFeature(int lat, int lon) {
		...
		Feature feature;
		try {
			feature = blockingStub.getFuture(request);
			if (testHelper != null) {
	...
	public void listFeatures(int lowLat, int lowLon, int hiLat, int hiLon) {
		...
		try {
			features = blockingStub.listFutures(request);
	...
	private void info(String msg, Object... params) {
		System.out.println(Level.INFO + msg + Arrays.toString(params));
	}

	private void warning(String msg, Object... params) {
		System.out.println(Level.WARNING + msg + Arrays.toString(params));
	}
