...
public class RouteGuideService extends RouteGuideGrpc.RouteGuideImplBase {
	 ...
	 */
	@Override
	public void getFuture(Point request, StreamObserver<Feature> responseObserver) {
	 ...
	 */
	@Override
	public void listFutures(Rectangle request, StreamObserver<Feature> responseObserver) {
